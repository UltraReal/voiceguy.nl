...
$db_host = "localhost";
$db_user = "root";  // Vervang dit met je database gebruikersnaam
$db_pass = "";      // Vervang dit met je database wachtwoord
...
$admin_email = "admin@voiceguy.nl";
$admin_password = password_hash("admin123", PASSWORD_DEFAULT); // Verander dit wachtwoord!
...
$settings = [
    ...
    ["site_description", "De officiële website van VoiceGuy, voice-over artiest en content creator."]
];
